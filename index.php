...
<!-- Formulario ingreso -->
				...
				<form id="ingoficio" action="ingoficio.php" method="post" enctype="multipart/form-data" >
							
								
					<input type="text" class="form-control form-group" name="glosa"  placeholder="Detalle oficio (RIT-año breve descripción)"  required>
					<input type="text" class="form-control form-group" name="origen"  placeholder="Origen (Unidad y/o Funcionario)"  maxlength="50" required>
					<input type="text" class="form-control form-group" name="destino"  placeholder="Destino (Entidad y/o Persona)" maxlength="50" required>
					...
					<select name="tipo" id="tipo" class="form-control mb-3" required>
					 ...
					 <div class="modal-footer">
				       		<button id="btningoficio" type="button bnt" class="btn btn-primary">Agregar</button>
				     </div>
						</form>
